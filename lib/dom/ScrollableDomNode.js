...
class ScrollableDomNode extends DomNode_1.default {
    constructor(domElement, options, createChild) {
        ...
        this.resizeDebouncer = new skydapp_common_1.Debouncer(100, () => this.calculateSize());
    ...
    add(data, index) {
        if (index !== undefined && index < this.nodeDataSet.length) {
            skydapp_common_1.SkyUtil.insert(this.nodeDataSet, index, { data, height: this.options.baseChildHeight });
        }
        else {
            this.nodeDataSet.push({ data, height: this.options.baseChildHeight });
        }
    ...
    move(data, to) {
        ...
        if (to !== undefined && to < this.nodeDataSet.length) {
            skydapp_common_1.SkyUtil.insert(this.nodeDataSet, to, { data, height: this.options.baseChildHeight });
        }
        else {
            this.nodeDataSet.push({ data, height: this.options.baseChildHeight });
        }
