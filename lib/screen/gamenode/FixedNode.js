...
class FixedNode extends GameNode_1.default {
    step(deltaTime, x, y, scaleX, scaleY, angle, sin, cos, alpha, hidden) {
        super.step(deltaTime, this.screen === undefined ? 0 : this.screen.camera.x, this.screen === undefined ? 0 : this.screen.camera.y, scaleX, scaleY, angle, sin, cos, alpha, hidden);
    }
}
