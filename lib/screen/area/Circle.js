...
class Circle extends Area_1.default {
    ...
    checkPoint(x, y) {
        ...
        return CollisionChecker_1.default.checkPointInCircle(x, y, this.parent.r_x, this.parent.r_y, this.width, this.height, this.parent.r_scaleX, this.parent.r_scaleY, this.parent.r_sin, this.parent.r_cos);
    }
}
